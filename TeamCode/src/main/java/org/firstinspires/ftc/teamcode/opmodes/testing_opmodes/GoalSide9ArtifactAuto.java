...
@Autonomous
public class GoalSide9ArtifactAuto extends NGAutoOpMode {
    @Override
    public void runOpMode() throws InterruptedException {

        Pose2d beginPose = new Pose2d(-56, -44 , Math.toRadians(55));
        initAuto(beginPose);
        ...
        TrajectoryActionBuilder moveBackwardPath = drive.actionBuilder(beginPose)
                .lineToY(-36, new TranslationalVelConstraint(80));
        TrajectoryActionBuilder PathToFirstSet = moveBackwardPath.endTrajectory().fresh()
                .splineToLinearHeading(new Pose2d(-13, -30, Math.toRadians(90)), Math.toRadians(-30), new TranslationalVelConstraint(60));
